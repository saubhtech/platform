...
export default function SaubhOS() {
  ...
  const cards = [
    { id: 'data', icon: 'fas fa-chart-pie', title: t('saubhos.card1.title'), desc: t('saubhos.card1.desc'), delay: '0s' },
    { id: 'sales', icon: 'fas fa-headset', title: t('saubhos.card2.title'), desc: t('saubhos.card2.desc'), delay: '.1s' },
    { id: 'hr', icon: 'fas fa-users-gear', title: t('saubhos.card3.title'), desc: t('saubhos.card3.desc'), delay: '.2s' },
    { id: 'career', icon: 'fas fa-route', title: t('saubhos.card4.title'), desc: t('saubhos.card4.desc'), delay: '.3s' },
  ];
    ...
    <section className="saubhos section-pad" id="saubhos" aria-labelledby="saubhos-title">
      <div className="container">
        ...
        <div className="saubhos-grid">
          {cards.map((card) => (
            <div key={card.id} className="saubhos-card anim-up" style={{ transitionDelay: card.delay }}>
