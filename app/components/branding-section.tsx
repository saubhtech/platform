...
export default function BrandingSection() {
  ...
  useEffect(() => {
    ...
    if (section) {
      section.querySelectorAll('.anim-up, .brand-card').forEach((el) => observer.observe(el));
    }
  ...
  return (
    <section
      ref={sectionRef}
      className="brand-section section-pad"
      id="branding"
    ...
    >
      ...
      <div className="container brand-container">
        ...
        <div className="brand-header anim-up">
          ...
          <h2 className="brand-title" id="branding-title">
            No Business Without a <span className="brand-shimmer">Brand.</span>
          </h2>
          <p className="brand-sub anim-up">
            No Brand Without <span className="brand-shimmer">Social Proof.</span>
          </p>
        </div>
          ...
          {cards.map((card, i) => (
            <div
              ...
              style={{
                ...
                ['--card-light' as string]: card.colorLight,
                ['--card-bg' as string]: card.colorBg,
              }}
            >
              {/* Top glow bar */}
      ...
      <style jsx>{`
        ...
        .brand-overlay {
          ...
          background:
            ...
            radial-gradient(ellipse 600px 400px at 20% 40%, rgba(109,179,63,0.06) 0%, transparent 70%),
            radial-gradient(ellipse 600px 400px at 80% 60%, rgba(232,85,58,0.04) 0%, transparent 70%);
          pointer-events: none;
        }
        ...
        .brand-card:hover .brand-card-icon {
          ...
          box-shadow: 0 0 30px var(--card-bg);
        }
        ...
        .brand-card-glow {
          ...
          background: radial-gradient(circle at 50% 0%, var(--card-bg), transparent 70%);
          opacity: 0;
